    ...
    <main>
      ...
      <nav>
        ...
        <ul className="nav-links">
          ...
          <li>
            <a href="mailto:hello@lethanie.com">Join</a>
          </li>
        </ul>
      </nav>
      ...
      <section className="hero">
        ...
        <div className="hero-label">Agentic AI Research Company — Founded in 2025</div>
        ...
        <div className="manifesto-layout reveal">
          ...
          <div className="manifesto-right">
            <p>
              ...
              of this decade. Not because the capability question has been solved — it largely has.
          ...
          <div className="product-main">
            ...
            <div>
              <p className="product-desc">
                ...
                execution — research, analysis, code, deployment, coordination — over long horizons
      ...
      <section className="join" id="join">
        ...
        <div className="join-right reveal">
          ...
          <a href="mailto:hello@lethanie.com" className="join-cta">
            Join Lethanie
          </a>
        </div>
      </section>
      ...
      <footer>
        ...
        <div className="footer-copy">© 2025 Lethanie — Agentic AI Research Company</div>
      </footer>
    </main>
  )
}
